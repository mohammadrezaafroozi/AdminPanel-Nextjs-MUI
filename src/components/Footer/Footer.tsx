...
const Footer = () => {
  ...
  return (
    <footer className="w-full sticky right-0 left-0 bottom-[-1rem] ">
      <Paper sx={{ width: "100%" }} color={"#262626"}>
        <ul role="menu" className="flex flex-wrap justify-center items-center m-auto *:p-[1rem] **:hover:bg-blue-900">
          <li>
